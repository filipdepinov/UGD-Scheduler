...
public final class ItemScheduleBinding implements ViewBinding {
  ...
  private ItemScheduleBinding(@NonNull CardView rootView, @NonNull TextView tvRoom,
      @NonNull TextView tvSubjectName, @NonNull TextView tvTime) {
  ...
  public static ItemScheduleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemScheduleBinding((CardView) rootView, tvRoom, tvSubjectName, tvTime);
    }
